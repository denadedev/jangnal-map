...
export default function PrivacyPage() {
  ...
  return (
    <>
      <MobileAppBar title="개인정보 안내" backHref="/" />
      <main className={styles.page}>
        <a className={styles.back} href="/">← 오늘 장날로 돌아가기</a>
        <article className={styles.card}>
          <h1>개인정보 처리 안내</h1>
          <h2>익명 이용 통계</h2>
          <p>서비스 이용 현황을 개선하기 위해 자체 운영하는 Umami Analytics로 방문 페이지, 유입 경로, 브라우저와 기기 유형, 국가 등의 익명 통계를 집계합니다. 이 도구는 분석용 쿠키를 사용하지 않으며 오늘장날은 이 통계로 개인을 식별하거나 여러 사이트에 걸쳐 추적하지 않습니다.</p>
